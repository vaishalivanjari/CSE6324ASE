...
from .examples.oddeven.cwe767_detector import CWE767Detector
from .examples.incorrectconstructor.incorrectConstructorName_detector import IncorrectConstructorName
